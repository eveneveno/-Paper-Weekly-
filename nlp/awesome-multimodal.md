...
<p align="center">
    <img src="img/places.jpg" alt="drawing" width="600"/>
</p>
<p align="center">
<img src="img/kb-2.png" alt="drawing" width="250"/>
<img src="img/kb-3.png" alt="drawing" width="400"/>
</p>

Example: 
`Location`: Asia, China, Beiding, Chaoyang District, 
`Place`: **798 Photo Gallery**
`Note`: Established in 2003 as the first gallery in China to focus on photography... 
`Section`: see, gallery  
...
- [Reading List for Topics in Multimodal Machine Learning](#reading-list-for-topics-in-multimodal-machine-learning)
      - [Analyzing the embedded vectors of words & vision objects in the (common) spaces.](#analyzing-the-embedded-vectors-of-words--vision-objects-in-the-common-spaces)
      - [Knowledge Graph for `Places Dataset`](#knowledge-graph-for-places-dataset)
      - [`MovieNet Dataset`](#movienet-dataset)
...
* Section II reviews recent progress in terms of developing representations for single or multiple modalities. 
* Section III introduces commonly used fusion methods with a focus on `attention mechanisms` and `bilinear pooling`. 
* Section IV introduces applications, including `caption generation`, `text-toimage generation`, `VQA`, and `visual reasoning`.
...
* Section II first introduces `ten prominent tasks` of integration of vision and language along with their methods
<p align="center">
    <img src="img/10tasks.png" alt="drawing" width="500"/>
</p>
  
  * `Extension of NLP Tasks`: Visual Description Generation / Visual Storytelling / Visual Question Answering / Visual Dialog / Visual Referring Expression / Visual Entailment / Multimodal Machine Translation 
  * `Extension of CV Tasks`: Visual Generation / Visual Reasoning
  * `Extension of both NLP and CV Tasks`: Vision-and-Language Navigation

* Section III gives an overview of the datasets used for each of these tasks. 
* Section IV describes the representation used for both vision and language separately and further discuss the major methods that combine both of them for realizing a task.
* Section VI compares benchmark results achieved for each task through the corresponding methods.
* Section VII&VIII discuss the possible future directions and concludes our survey with some insights into the findings.

[Deep Multimodal Representation Learning: A Survey](https://ieeexplore.ieee.org/abstract/document/8715409), arXiv 2019 
*  Section II discusses the key issues on how to narrow the heterogeneity gap in three types of frameworks.
*  Section III reviews the typical models listed in Table 1.
<p align="center">
  <img src="img/multi-repre.png" alt="drawing" width="600"/>
  <img src="img/gan.png" alt="drawing" width="600"/>
  <img src="img/summary.png" alt="drawing" width="700"/>
</p>

[Multimodal Machine Learning: A Survey and Taxonomy](https://arxiv.org/abs/1705.09406), TPAMI 2018
<p align="center">
  <img src="img/5challenges.png" alt="drawing" width="600"/>
</p>
...
* The **NCE loss** is at the center of many recent representation learning methods. Similar to the triplet loss, the basic principle behind NCE is to maximize the similarity between an anchor data point and a positive data point while minimizing similarity to all other (negative) points.
...
<p align="center">
  <img src="img/metaconcept.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/vlbert.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/12in1.png" alt="drawing" width="300"/>
</p>
...
<p align="center">
  <img src="img/lxmert.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/vico-teaser.png" alt="drawing" width="400"/>
  <img src="img/vico.png" alt="drawing" width="400"/>
</p>
...
<p align="center">
  <img src="img/videobert.png" alt="drawing" width="400"/>
  <img src="img/videobert-2.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/vse.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/devise.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/order-embedding.png" alt="drawing" width="300"/>
</p>
...
<p align="center">
  <img src="img/kb.png" alt="drawing" width="600"/>
</p>
...
<p align="center">
  <img src="img/violin.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/gqa.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/recipe.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/heter.png" alt="drawing" width="500"/>
</p>
...
<p align="center">
  <img src="img/hollywood.png" alt="drawing" width="500"/>
</p>
